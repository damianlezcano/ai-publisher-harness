...
- Owned paths: `docs/HARNESS_ENGINEERING.md`, `AGENTS.md`, `docs/architecture-contracts/README.md`.
- Allowed paths: `docs/AGENT_POLICY.md`; Prohibited paths: remote CI configuration and product code.
...
- Commands: `rg -n 'HARD|SOFT|DOCUMENTARY|Future hardening' docs/HARNESS_ENGINEERING.md`; `git diff --check`.
