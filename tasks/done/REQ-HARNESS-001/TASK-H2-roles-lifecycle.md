...
- Owned paths: `AGENTS.md`, `docs/engineering/REQUIREMENTS.md`, `prompts/`, `tasks/`, `RUNTIME.md`.
- Allowed paths: `docs/engineering/HARNESS_ENGINEERING.md`; Prohibited paths: product code and protected product contracts.
