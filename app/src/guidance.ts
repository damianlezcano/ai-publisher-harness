...
const GUIDANCE: Record<string, ErrorGuidance> = {
  ...
  material_too_large: compose(messages.error.materialFailed, []),
  material_image_invalid: compose(messages.error.materialFailed, []),
  attachment_invalid: compose(messages.error.materialFailed, []),
