...
Engineering para EducAI. Define cómo se organiza y verifica el trabajo asistido
por agentes; no reemplaza las autoridades de producto, arquitectura, seguridad,
UX ni los ADRs. Las decisiones operativas cambiables de runtime están en
`RUNTIME.md` y no se codifican aquí por proveedor o modelo.
...
(`docs/REQUIREMENTS.md`, `tasks/`), runtime (`RUNTIME.md`), contratos de
