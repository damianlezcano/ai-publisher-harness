...
| 7 | Named suites wiring + verify gate + smoke script + docs/engineering/VERIFY | MEDIUM/HIGH | 5,6 | `m8/m8-tests` | tests, scripts, docs/engineering/VERIFY |
...
M8 keeps M7 and adds (offline, deterministic; documented in `docs/engineering/VERIFY.md`):
