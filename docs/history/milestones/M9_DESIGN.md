...
- One **message catalog** (`app/src/messages.ts`) becomes the single source of
  ...
  i18n-ready (ADR-0012).
- **Canonical vocabulary** is fixed in `docs/product/UX.md` and reflected in the
...
Defined in `docs/product/UX.md` and implemented by `messages.ts`. Spanish (`es-AR`),
...
docs/product/UX.md                     UPDATE canonical vocabulary + sharing messaging
docs/engineering/VERIFY.md                 UPDATE M9 section + gate
...
- [ ] ADR-0012 accepted and `docs/product/UX.md` canonical vocabulary confirmed before code.
...
`docs/engineering/VERIFY.md` gains a short M9 section documenting that M9 is frontend-only
