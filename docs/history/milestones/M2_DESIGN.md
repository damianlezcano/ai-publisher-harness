...
| 5. Verify/integration | 1–4 reviewed | `scripts/verify`, `docs/engineering/VERIFY.md`, integration wiring | Codex Tierra / Antigravity | Exact M2 gate wired; no frontend tooling; `./scripts/verify`, `git diff --check` |
...
The prompt includes the no-redesign rule in `docs/engineering/AGENT_POLICY.md`; the worker
