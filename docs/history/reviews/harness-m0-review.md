...
- Test expectations were implicit; `docs/engineering/TESTING.md` defines levels, fixtures,
...
- Worktree and author/reviewer boundaries were principles rather than an
  operational workflow; `docs/engineering/WORKTREES.md` and
  `docs/engineering/MULTI_AGENT_WORKFLOW.md` make them executable.
...
to a later ADR or the relevant milestone and must update `docs/engineering/VERIFY.md` when
...
operating policy is now `docs/engineering/AGENT_POLICY.md`: classify work LOW/MEDIUM/HIGH,
