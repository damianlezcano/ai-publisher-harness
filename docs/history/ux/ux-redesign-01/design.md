...
Worker-model allocation in sections 24/25 was superseded by the owner's 2026-08-31 directive persisted in `docs/engineering/AGENT_POLICY.md`.
Date: 2026-08-31
Scope: Architecture-only. Enables the approved chat-first UX (`UX_RELEASE_GATE_01`,
`docs/product/UX.md` §"Main screens") with the **smallest additive delta** over M1–M10.
...
From `docs/history/ux/ux-release-gate-01/report.md` §5–§6 (all reproduced against the running UI):
...
Reuse the `UX_RELEASE_GATE_01` harness (`docs/history/ux/ux-release-gate-01/evidence/`, the
...
| T6 | Playwright headed visual + a11y suite | `app/` (or `/tmp/opencode/ux-review` harness), `docs/history/ux/ux-redesign-01/evidence/` evidence | §20/§21 |
...
- Every applicable box in `docs/engineering/DEFINITION_OF_DONE.md`.
...
- No security invariant in `docs/product/SECURITY.md` regressed (§18 named tests).
