...
> Read this report with the evidence under `docs/history/ux/ux-release-gate-01/evidence/` (screenshots, per-screenshot
...
Evidence index (all under `docs/history/ux/ux-release-gate-01/evidence/`):
...
- Source of truth read: `AGENTS.md`, `docs/engineering/AGENT_POLICY.md`, `docs/CURRENT_CHECKPOINT.md`,
  `docs/history/milestones/M9_DESIGN.md`, `docs/product/UX.md`, `docs/product/PRODUCT.md`, `CODEX_HANDOFF.md`.
- **No approved mockup/wireframe file exists in the repository**; the reference direction is the one
  ...
  separate / RESOURCES in-context), cross-checked against `docs/product/UX.md` and `docs/history/milestones/M9_DESIGN.md`.
