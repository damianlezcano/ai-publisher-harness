...
This document is the test strategy: levels, fixtures, and behavior-specific
evidence. It does not define the executable final gate (`docs/engineering/VERIFY.md`)
or the work-closure checklist (`docs/engineering/DEFINITION_OF_DONE.md`).
