...
This document is the work-closure checklist (scope, review, handoff). It does
not replace `docs/engineering/TESTING.md` (what to test) or
`docs/engineering/VERIFY.md` (the executable `scripts/verify` contract).
...
- [ ] User-facing text uses the vocabulary in `docs/product/UX.md`; internal mechanics
...
- [ ] Each affected invariant in `docs/product/SECURITY.md` is either unaffected or has
