...
This document is the executable final-gate contract and milestone command
wiring. Test strategy lives in `docs/engineering/TESTING.md`. Closure/handoff
checklist lives in `docs/engineering/DEFINITION_OF_DONE.md`.
...
exist. The exact intended commands are recorded in `docs/history/milestones/M2_DESIGN.md`:
...
`project_migration`. Commands match `docs/history/milestones/M3_DESIGN.md`. The script skips a
...
`publication_tunnel`. Commands match `docs/history/milestones/M4_DESIGN.md`. All M4 suites are
...
`agent_security`, `agent_lifecycle`). Commands match `docs/history/milestones/M5_DESIGN.md`. All M5
